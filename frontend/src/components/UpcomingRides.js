...
import UpcomingSingleRide from './PastOrUpcomingSingleRide';
...
export default class UpcomingRides extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        const rideDetails = (await axios.get(url.module + `/getUpcomingRides/${user.driverLicense}&datefrom=${moment().format('YYYY-MM-DD')}&timeFrom=${moment().format('HH:mm:ss')}&pastOrUpcoming=upcoming`)).data        
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-12">
                                <div className="section-title  text-center">
                                    ...
                                    <p>Track all your upcoming rides here</p>
                                </div>
                            </div>
                ...
                <div>
                    {
                        this.state.rideDetails && this.state.rideDetails.cars.map((_, index) => (
                            <UpcomingSingleRide key={index}{...this.state.rideDetails.cars[index]} {...this.state.rideDetails.upcomingRides[index]} dataFrom="upcoming"/>
                        ))
                    }
                </div>
